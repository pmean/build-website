...
You can find an [earlier version](http://www.pmean.com/05/bayesian.html) of this page on my [original website](http://www.pmean.com/original_site.html).
You can find an [earlier version](http://www.pmean.com/05/Bimodality.html) of this page on my [original website](http://www.pmean.com/original_site.html). Testing for bimodality
You can find an [earlier version](http://www.pmean.com/05/CaseCohort.html) of this page on my [original website](http://www.pmean.com/original_site.html). Case cohort design
You can find an [earlier version](http://www.pmean.com/05/CensoredValues.html) of this page on my [original website](http://www.pmean.com/original_site.html). More than 90% censored values
You can find an [earlier version](http://www.pmean.com/05/ChanceWiki.html) of this page on my [original website](http://www.pmean.com/original_site.html). Publication in the ChanceWiki
You can find an [earlier version](http://www.pmean.com/05/ChanceWikiA.html) of this page on my [original website](http://www.pmean.com/original_site.html). Two articles in the Chance Wiki
You can find an [earlier version](http://www.pmean.com/05/ChangesStatL.html) of this page on my [original website](http://www.pmean.com/original_site.html). Changes to STAT-L/sci.stat.consult
You can find an [earlier version](http://www.pmean.com/05/ClinicalImportance.html) of this page on my [original website](http://www.pmean.com/original_site.html). Clinical importance
You can find an [earlier version](http://www.pmean.com/05/ClinicalImportanceA.html) of this page on my [original website](http://www.pmean.com/original_site.html). Confidence intervals are needed to evaluate clinical importance 
You can find an [earlier version](http://www.pmean.com/05/CollectionStudies.html) of this page on my [original website](http://www.pmean.com/original_site.html). A collection of randomized and non-randomized studies
You can find an [earlier version](http://www.pmean.com/05/ComingSoon.html) of this page on my [original website](http://www.pmean.com/original_site.html). Coming soon
You can find an [earlier version](http://www.pmean.com/05/ConfidenceInterval.html) of this page on my [original website](http://www.pmean.com/original_site.html). Where is the confidence interval?
You can find an [earlier version](http://www.pmean.com/05/ConfidenceIntervalA.html) of this page on my [original website](http://www.pmean.com/original_site.html). Confidence intervals around a safety level
You can find an [earlier version](http://www.pmean.com/05/ConfidenceIntervalB.html) of this page on my [original website](http://www.pmean.com/original_site.html). Examples of confidence intervals
You can find an [earlier version](http://www.pmean.com/05/ConflictInterest.html) of this page on my [original website](http://www.pmean.com/original_site.html). More on conflicts of interest
You can find an [earlier version](http://www.pmean.com/05/ConflictInterestA.html) of this page on my [original website](http://www.pmean.com/original_site.html). Taking charges of conflicting interest too far
You can find an [earlier version](http://www.pmean.com/05/ConfusionPvalues.html) of this page on my [original website](http://www.pmean.com/original_site.html). Confusion about p-values
You can find an [earlier version](http://www.pmean.com/05/ConsecutiveDates.html) of this page on my [original website](http://www.pmean.com/original_site.html). Placing consecutive dates in a column of an SPSS file
You can find an [earlier version](http://www.pmean.com/05/ContinuousVariables.html) of this page on my [original website](http://www.pmean.com/original_site.html). Continuous variables in a logistic regression model 
You can find an [earlier version](http://www.pmean.com/05/ControlCharts.html) of this page on my [original website](http://www.pmean.com/original_site.html). Control charts for monitoring mortality rates
You can find an [earlier version](http://www.pmean.com/05/ControversialMetaanalysis.html) of this page on my [original website](http://www.pmean.com/original_site.html). A controversial meta-analysis
You can find an [earlier version](http://www.pmean.com/05/ConvertOddsRatio.html) of this page on my [original website](http://www.pmean.com/original_site.html). Converting an odds ratio to a relative risk
You can find an [earlier version](http://www.pmean.com/05/CorrelationCoefficient.html) of this page on my [original website](http://www.pmean.com/original_site.html). Confidence interval for a correlation coefficient
You can find an [earlier version](http://www.pmean.com/05/CovariateImbalance.html) of this page on my [original website](http://www.pmean.com/original_site.html). Adjusting for covariate imbalance
You can find an [earlier version](http://www.pmean.com/05/CriticalThinking.html) of this page on my [original website](http://www.pmean.com/original_site.html). What is critical thinking?
You can find an [earlier version](http://www.pmean.com/05/CronbachsAlpha.html) of this page on my [original website](http://www.pmean.com/original_site.html). Very low values from Cronbach's Alpha
You can find an [earlier version](http://www.pmean.com/05/CumulativeMetaanalysis.html) of this page on my [original website](http://www.pmean.com/original_site.html). Cumulative meta-analysis
You can find an [earlier version](http://www.pmean.com/05/DataMining.html) of this page on my [original website](http://www.pmean.com/original_site.html). Two cautionary tales about data mining
You can find an [earlier version](http://www.pmean.com/05/DatesInR.html) of this page on my [original website](http://www.pmean.com/original_site.html). Dates in Excel and R
You can find an [earlier version](http://www.pmean.com/05/DiagnosticMetaanalysis.html) of this page on my [original website](http://www.pmean.com/original_site.html). Meta-analysis for a diagnostic test
You can find an [earlier version](http://www.pmean.com/05/DigitalObjectIdentifier.html) of this page on my [original website](http://www.pmean.com/original_site.html). The Digital Object Identifier
You can find an [earlier version](http://www.pmean.com/05/DigitizingGraph.html) of this page on my [original website](http://www.pmean.com/original_site.html). Digitizing a graph
You can find an [earlier version](http://www.pmean.com/05/DimensionReduction.html) of this page on my [original website](http://www.pmean.com/original_site.html). Dimension reduction in a microarray experiment
You can find an [earlier version](http://www.pmean.com/05/DisasterAverted.html) of this page on my [original website](http://www.pmean.com/original_site.html). A disaster averted
You can find an [earlier version](http://www.pmean.com/05/DisasterAvertedA.html) of this page on my [original website](http://www.pmean.com/original_site.html). Another disaster averted
You can find an [earlier version](http://www.pmean.com/05/DishonestyResearch.html) of this page on my [original website](http://www.pmean.com/original_site.html). Dishonesty in medical research
You can find an [earlier version](http://www.pmean.com/05/DumpingData.html) of this page on my [original website](http://www.pmean.com/original_site.html). Dumping data from R to a text file
You can find an [earlier version](http://www.pmean.com/05/EndSpam.html) of this page on my [original website](http://www.pmean.com/original_site.html). Technology to end spam
You can find an [earlier version](http://www.pmean.com/05/EnoughData.html) of this page on my [original website](http://www.pmean.com/original_site.html). Do I have enough data after 24 months of time?
