...
Assume that both the mean and the precision of the normal distribution are unknown. Earlier cases with [mean unknown and precision known][sim1] and with [mean known and precision unknown][sim2] appear on a different web pages.
