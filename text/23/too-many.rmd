...
First, the ends of the rainbow do not show enough contrast. In the above map, the low poverty rate of New Hampshire (9.2%) is a red that differs only slightly from high poverty rate of Mississippi (21.9%) shown as magenta. If anything, the contrast is bigger between Mississippi (magenta) and Alabama (blue) even though the poverty rates of 19.2% for Alabama is a lot closer than New Hampshire's.
