...
Assume that $\tau$ is known and equal to $\tau_F$. A more general case, with $\tau$ unknown is described on a separate web page. For simplicity, we will drop any multiplicative constants not involving X or $\theta$
