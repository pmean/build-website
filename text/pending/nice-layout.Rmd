...
While it is easy to get R to produce descriptive statistics for categorical outcomes in a research study, it is a bit harder to get R to produce a layout that is publication-ready. Hard, but not impossible. Here is a simple example.Here is a brief abstract.
