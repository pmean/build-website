---
title: "Blog post: Gender distribution of panel discussions"
author: "Steve Simon"
source: "New"
date: "2020-02-06"
category: Blog post
tags: Human side of statistics, R software
output: html_document
---

I was curious, while I was attending the Joint Statistical Meetings (JSM) in August 2019 about the gender distribution of the panel discussions. There had been a lot of controversy at several scientific meetings about "manels," panel discussions that had all or almost all males. So I copied the JSM program into a text file and wrote a short R program to analyze this.

<!---More--->

Here are the R libraries that I need for this program. The suppressWarnings and suppressMessages functions help to keep the output clean.
...
The text file has a consistent format that makes it easy to identify things. The first panelist is on a line starting with the text "Panelists:" and the last panelist appears just before the line with the text "Floor Discussion".
