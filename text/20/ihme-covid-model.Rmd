...
The alternative SEIR models generally use information from the daily infection rate to estimate parameters and buil predictions, though they can incorporate information from the 
...
Bui Q, Katz J, Parlapiano A, and Sanger-Katz, M. What 5 Coronavirus Models Say the Next Month Will Look Like. The New York Times, 2020-04-22. Available in [html format](https://www.nytimes.com/interactive/2020/04/22/upshot/coronavirus-models.html).
...
Chow D. What we know about the coronavirus model the White House unveiled. NBC News, 2020-04-01. Available in [html format](https://www.nbcnews.com/science/science-news/what-we-know-about-coronavirus-model-white-house-unveiled-n1173601).
...
Etzioni R, COVID-19 Models: What Makes Them Tick? Timmerman Report, 2020-04-07. Available in [html format](https://timmermanreport.com/2020/04/covid-19-models-what-makes-them-tick/).
...
Mortality Modeling FAQ. Available in [html format](https://covid-19.tacc.utexas.edu/mortality-projection-faq/).
...
Social Distancing: Data Models for a Model Response to an Outbreak. Available in [html format](https://sph.umich.edu/news/2020posts/data-models-for-a-model-response-to-an-outbreak.html).
...
Chowell G, Sattenspiel L, Bansal S, Viboud C. Mathematical models to characterize early epidemic growth: A review. Phys Life Rev. 2016;18:66–97. doi:10.1016/j.plrev.2016.07.005. Available in [html format](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5348083/) or [pdf format](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5348083/pdf/nihms-802148.pdf).
...
Kissler SM, Tediganto C, Goldstein E, Grad YH, Lipsitch M. Projecting the transmission dynamics of SARS-CoV-2 through the postpandemic period. Science 2020-04-14. DOI: 10.1126/science.abb5793, Available in [html format](https://science.sciencemag.org/content/early/2020/04/24/science.abb5793).
...
FRED Modeling System. Available in [html format](https://fred.publichealth.pitt.edu/).
...
Ayoub HH, Chemaitelly H, Mumtaz GR, Seedat S, Awad SF, Makhoul M, Abu-Raddad LJ. Characterizing key attributes of the epidemiology of COVID-19 in China: Model-based estimations. Preprint published in Medrxiv, 2020-04-11. Available in [pdf format](https://www.medrxiv.org/content/10.1101/2020.04.08.20058214v1.full.pdf).
...
Wang L, Wang G, Gao L, Li X, Yu S, Kim M, Wang Y, Gu Z. Spatiotemporal Dynamics, Nowcasting and Forecasting of COVID-19 in the United States. Preprint published in Arxiv, 2020-04-30. Available in [pdf format](https://arxiv.org/pdf/2004.14103.pdf).

+ This article fits an SEIR model to individual counties in the United States with a large number of county specific covariates. The model produces a [nice dashboard](https://covid19.stat.iastate.edu/).
