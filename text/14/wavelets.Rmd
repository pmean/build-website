...
level_wavelet <- function(wt.rwt, i) {
  v <-wt.rwt$y
  v[(2^(i-1)):(2^i)] <- 0
  as.vector(midwt(v, d4.rwt$h.0, L=9)$x)
}
```
...
dot.prod(V2, g,1),V3[1],"V3[1]")
V3[1]
By hand -0.28061
Using R -0.28061
dot.prod(V2, g,3),V3[2],"V3[2]")
V3[2]
By hand -0.2404948
Using R -0.2404948
dot.prod(V2, g,5),V3[3],"V3[3]")
V3[3]
By hand -0.2919882
Using R -0.2919882
...
dot.prod(V2,-h,1),W3[1],"W3[1]")
W3[1]
By hand -0.002777659
Using R -0.002777659
dot.prod(V2,-h,3),W3[2],"W3[2]")
W3[2]
By hand 0.03857375
Using R 0.03857375
dot.prod(V2,-h,5),W2[3],"W3[3]")
W3[3]
...
W8d <- dilute(W8)
V8d <- dilute(V8)
 dot.prod(W8d,g,14)+dot.prod(V8d,h,14),V7[1],"V7[1]")
V7[1]
By hand -3.315508
Using R -3.315508
-dot.prod(W8d,g,15)-dot.prod(V8d,h,15),V7[2],"V7[2]")
V7[2]
By hand -2.398146
Using R -2.398146
 dot.prod(W8d,g,16)+dot.prod(V8d,h,16),V7[3],"V7[3]")
V7[3]
By hand -0.2769286
Using R -0.2769286
-dot.prod(W8d,g, 1)-dot.prod(V8d,h, 1),V7[4],"V7[4]")
V7[4]
By hand 1.782748
Using R 1.782748
 dot.prod(W8d,g, 2)+dot.prod(V8d,h, 2),V7[5],"V7[5]")
V7[5]
By hand 5.25007
Using R 5.25007
-dot.prod(W8d,g, 3)-dot.prod(V8d,h, 3),V7[6],"V7[6]")
V7[6]
By hand 4.7496
Using R 4.7496
...
W7d <- dilute(W7)
V7d <- dilute(V7)
 dot.prod(W7d,g,30)+dot.prod(V7d,h,30),V6[1],"V6[1]")
V6[1]
By hand -2.096562
Using R -2.096562
-dot.prod(W7d,g,31)-dot.prod(V7d,h,31),V6[2],"V6[2]")
V6[2]
By hand -2.294492
Using R -2.294492
 dot.prod(W7d,g,32)+dot.prod(V7d,h,32),V6[3],"V6[3]")
V6[3]
By hand -2.441797
Using R -2.441797
-dot.prod(W7d,g, 1)-dot.prod(V7d,h, 1),V6[4],"V6[4]")
V6[4]
By hand -1.265345
Using R -1.265345
 dot.prod(W7d,g, 2)+dot.prod(V7d,h, 2),V6[5],"V6[5]")
V6[5]
By hand -0.6650157
Using R -0.6650157
-dot.prod(W7d,g, 3)-dot.prod(V7d,h, 3),V6[6],"V6[6]")
V6[6]
By hand 0.08738041
Using R 0.08738041
...
W1d <- dilute(W1)
V1d <- dilute(V1)
 dot.prod(W1d,g,2046)+dot.prod(V1d,h,2046),ecg[1],"ecg[1]")
ecg[1]
By hand -0.104773
Using R -0.104773
-dot.prod(W1d,g,2047)-dot.prod(V1d,h,2047),ecg[2],"ecg[2]")
ecg[2]
By hand -0.093136
Using R -0.093136
 dot.prod(W1d,g,2048)+dot.prod(V1d,h,2048),ecg[3],"ecg[3]")
ecg[3]
By hand -0.0815
Using R -0.0815
-dot.prod(W1d,g, 1)-dot.prod(V1d,h, 1),ecg[4],"ecg[4]")
ecg[4]
By hand -0.116409
Using R -0.116409
 dot.prod(W1d,g, 2)+dot.prod(V1d,h, 2),ecg[5],"ecg[5]")
ecg[5]
By hand -0.0815
Using R -0.0815
-dot.prod(W1d,g, 3)-dot.prod(V1d,h, 3),ecg[6],"ecg[6]")
ecg[6]
By hand -0.116409
Using R -0.116409
