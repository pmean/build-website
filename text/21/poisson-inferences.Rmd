...
by first getting a confidence interval for 

$\frac{\lambda_1 T_1}{\lambda_2 T_2}$

and then dividing the interval by

$\frac{T_1}{T_2}$

Start by noting that

$ln\big(\frac{X_1}{X_2}\big)=ln(X_1)-ln(X_2)$

As long as the two groups are independent, the variance of the difference is just the sum of the variances, so you can use

$ln(X_1)-ln(X_2) \pm z_{\alpha/2}\sqrt{\frac{1}{X_1}+\frac{1}{X_2}}$

as an approximate confidence interval for

$\frac{\lambda_1 T_1}{\lambda_2 T_2}$

Then exponentiate both sides of the interval and adjust by divinding by $T_1/T_2$.

### Example

In a [2018 article][kuma1] published in the Indian Journal of Dermatology, the researchers compared the incidence rates of leprosy in different age groups. In patients under the age of 14 there were 33 cases cumulated across 290508.9 patient years. In patients 15-29, there were 52 cases 141,112.0 patient years. Here are the calculations for the confidence interval for the rate ratio.

First calculate the rates and their ratio. Since rates are so low, adjust them to a rate per 10,000 patient years.
...
Calculate the interval for $ln(\lambda_1 T_1/\lambda_2 T_2)$.
...
Adjust for the patient years. Don't forget to round your final answer.
