...
Francis Huang has a [nice web page][hua1] showing two datasets and how to analyze them using the Poisson regression model, the negative binomial model and several others. The first data set is available for anyone to download.
