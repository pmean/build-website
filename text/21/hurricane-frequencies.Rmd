...
This [dataset on hurricane frequency][dasl1] is found at the [Data and Story Library website][dasl2]. 
...
This code reads data directly from the website and prints out the first eight rows.
...
This code is for printing the rest of the data.
...
It took a bit of work to put everything in a function, but now you can produce a quadratic rather than a linear trend with just a single line of code.
...
Here's code for fitting the remaining trend lines.
