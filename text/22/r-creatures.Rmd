...
You can (and probably should) use names for each element of your list. This makes it easier to pick out pieces of list.
...
The programming team working on the tidyverse has developed an alternative to the data frame called a tibble. You use the `tibble` function to create a tibble. But first you have to load the tidyverse packages (or just the tibble package by itself)
