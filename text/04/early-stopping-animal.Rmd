...
Ludbrook J. Interim analyses of data as they accumulate in laboratory
experimentation. BMC Med Res Methodol 2003: 3(1); 15.
...
Avialable in [html format](http://www.biomedcentral.com/1471-2288/3/15)
or [pdf format](http://www.biomedcentral.com/content/pdf/1471-2288-3-15.pdf)

+ The Ludbrook reference points out that laboratory
experiments often fail to account properly for early stopping
(interim analysis) and suggests an approach for handling this
properly.

You can find an [earlier version](http://www.pmean.com/04/EarlyStoppingAnimal.html) of this page on my [original website](http://www.pmean.com/original_site.html).
