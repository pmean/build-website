...
![](images/pchart01.gif){width="150" height="38"}
...
![](images/pchart02.gif){width="151" height="38"}

The average proportion is 0.3275 and n is 50. The control limits are
computed as

![](images/pchart03.gif){width="295" height="33"}

Here is what the control chart looks like:

![](images/pchart04.gif){width="396" height="290"}
