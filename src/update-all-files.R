...
update_all <- TRUE; source(file="src/step5-translate-archive.R")

update_all <- FALSE; source(file="src/step1-translate-bib-to-md.R")
update_all <- FALSE; source(file="src/step2-augment-md-files.R")
update_all <- FALSE; source(file="src/step3-build-archive-files.R")
update_all <- FALSE; source(file="src/step4-translate-md-to-html.R")
update_all <- FALSE; source(file="src/step5-translate-archive.R")
